                        ...
                        <div class="panel-body">
                          ...
                          <!--  <div class="form-group">
							...
							<div class="form-group">
									  ...
									  <input class="form-control" type="text" name="nama" value="<?php echo $row['kursus'] ?>" readonly>
	
							</div>
							<div class="form-group">
                                            <label>NO. PELAJAR</label>
                                            <input class="form-control" name="nopelajar" value="<?php echo $row['nopelajar'] ?>" readonly>
                                          <!--  <p class="help-block">CONTOH (BIXXXXXXXX)</p> -->
                                        </div>
										<div class="form-group">
                                            <label>NO. TELEFON</label>
                                            <input class="form-control" type="text" name="notelefon" value="<?php echo $row['notel'] ?>" readonly>
                                    <!-- <p class="help-block">(CONTOH 010-XXXXXXX)</p> -->
                            </div>
										 <div class="form-group">
                                            <label>EMEL</label>
                                            <input class="form-control" type="text" name="emel" value="<?php echo $row['emel'] ?>" readonly>
								...
								<div class="form-group" >
                                            <label>ALAMAT</label>
                                            <input class="form-control" rows="4" name="alamat" value="<?php echo $row['alamat'] ?>" readonly>

								</div>
																<div class="form-group" >
                                            <label>POSKOD</label>
                                            <input class="form-control" rows="4" name="alamat1" value="<?php echo $row['alamat'] ?>" readonly>

								</div>
																<div class="form-group" >
                                            <label>DAERAH</label>
                                            <input class="form-control" rows="4" name="alamat2" value="<?php echo $row['alamat'] ?>" readonly>
