...
<body> <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom:0; background-color: #1976D2;" >
                <div class="row">
             <!--   <a href="login1.html" class="btn btn-info" title="Log Masuk" >Pentadbir Sistem</a> -->
  ...
  <form class="modal-content animate" action="process.php" method="post" >
	...
	<div class ="col-md-9">
	 ...
	 <div class="container">
      ...
      <span class="psw">Lupa Kata Laluan?<a href="#">klik di sini</a></span>
    </div> 
  </form>
...
<div id="id03" class="modal1" style="background-image: url('ilpkk.jpg')";>
  
  <form name="daftar" class="modal-content animate" action="addregister.php" onsubmit="return validateForm()" method="post">
  <!--  <div class="imgcontainer">
      <span onclick="document.getElementById('id03').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="assets/img/avatar5.png" alt="Avatar" class="avatar">
    </div> -->
...
function validateForm() {
  var x = document.forms["daftar"]["uname"]["fname"]["psw"]["psw2"].value;
  if (x == "") {
